# Extending the PingOne Environment Directory Schema Example

This example deploys a Simple SSO Environment and shows how the output variables can be used to add additional attributes to the directory schema.
